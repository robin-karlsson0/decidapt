...
class ActionDecisionActionServer(Node):
    ...
    Parameters:
        ...
        log_pred_io_pth (str): Directory path for logging LLM prediction
                              ...
                              performed (default: '')
        manual_mode (bool): Enable manual file-based input mode instead of LLM
                           inference for debugging (default: False)
    ...
    def __init__(self, **kwargs):
        ...
        if self.manual_mode:
            ...
            self.get_logger().info(
                f"Manual mode enabled - waiting for file input at 'manual_action.txt'"  # noqa
            )
        elif self.inference_server_type.lower() == 'tgi':
            ...
            raise ValueError(f"Unsupported inference_server_type: "
                             ...
                             f"Supported types: 'tgi', 'vllm', 'manual'")
